...
//           <Col md={6} className="hero-image-container text-center order-1 order-md-2 mb-4 mb-md-0">
//             <div className="image-wrapper">
//               {/* Decorative rings */}
//               <div className="ring-outer"></div>
//               <div className="ring-inner"></div>
...
//           <Col md={6} className="hero-text order-2 order-md-1">
//             <h1 className="hero-title">Fiona A. Aladina</h1>
...
//               </div>
//               <h2 className="stat-number stat-number-blue">800+</h2>
//               <p> Young people trained in ICT, life skills, and entrepreneurship</p>
//             </div>
//           </Col>
...
// const Home = () => {
//   const heroStyle = {
//     backgroundImage: `url(${process.env.PUBLIC_URL}/cldn.jpg)`
//   };
...
//             <Col lg={9} xl={8}>
//               <h1 className="hero-title-bg">Fiona A. Aladina</h1>
//               <p className="hero-subtitle-bg">
//                 Empowering Growth, Resilience, and Digital Innovation
//               </p>
//               <p className="hero-description-bg">
//                 Software engineer, tech trainer, and community leader dedicated to helping young people develop essential digital skills and fostering innovation in technology education.
//               </p>
//               <div className="hero-buttons-bg">
//                 <Button
//                   as={Link}
//                   to="/gallery"
//                   className="btn-white"
        ...
        <Container className="hero-content">
          <Row className="justify-content-start">
            <Col lg={9} xl={8}>
              ...
              <p className="hero-description-bg">
                Software engineer, tech trainer, and community leader dedicated
                to helping young people develop essential digital skills and
                fostering innovation in technology education.
              </p>
              <div className="hero-buttons-bg">
                <Button as={Link} to="/gallery" className="custom-btn-primary">
                  View My Work
                </Button>
                <Button as={Link} to="/contact" className="custom-btn-orange">
                  Get in Touch
                </Button>
              </div>
            </Col>
        ...
        <Row className="stats-section mt-5 text-center">
          <Col md={4} className="stat-card mb-3">
            <div className="stat-content">
              ...
              <h2 className="stat-number stat-number-blue">800+</h2>
              <p>
                Young people trained in ICT, life skills, and entrepreneurship
              </p>
            </div>
          </Col>
          ...
          <Col md={4} className="stat-card mb-3">
            <div className="stat-content">
              ...
              <h2 className="stat-number stat-number-orange">100+</h2>
              <p>
                Young people equipped with technology skills through Makerspace
                programs
              </p>
            </div>
          </Col>
